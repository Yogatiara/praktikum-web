  ...
  return (
    <>
      <div className="bg-[#F0F0F0] h-full">
        ...
        <div
          className="h-60 md:h-[500px] lg:h-[700px] xl:h-[900px] bg-cover lg:bg-center xl:bg-center"
        ...
        >
          <div className="pl-[80px] pt-[258px] ">
            ...
            <div className="text-[#0e2e50] font-semibold pt-4 font-roboto text-2xl">
              <p>
                "Melayani masyarakat yang ingin menyewa fasilitas pemerintah"
              </p>
            </div>
        ...
        <div className="mt-56">
          <div>
            <h3 className="font-inter text-4xl text-center tracking-tighter font-extrabold ">
